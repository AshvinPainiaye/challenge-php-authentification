                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <div class="well">
                            ...
                            <?php  $form->startForm('','post'); ?>
                                      ...
                                      <?php  $form->input('label-static','name','text', $name); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php  $form->input('label-static','distance','text', $distance); ?>

                                    <?php  $form->input('label-static','duration','text', $duration); ?>

                                    <?php  $form->input('label-static','height_difference','text', $height_difference); ?>
